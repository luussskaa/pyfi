...
export default function ExtractCard({ allOff, title, value, total, expenses, handleExtract, invoice }) {
    return (
        <div className="w-11/12 flex flex-col justify-center items-start px-10 mt-3 cursor-pointer rounded-3xl mx-auto shadow-md border border-white hover:scale-105 hover:my-10 duration-300">
