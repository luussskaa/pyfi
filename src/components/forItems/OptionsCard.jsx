...
export default function OptionsCard({ allOff, handleOptions, handleEdit2, handleRemove, handlePay2, formValue, maxResource, handleExtract, expenses, handleWithdraw, handleSave, savings, handleTransfer }) {
    return (
