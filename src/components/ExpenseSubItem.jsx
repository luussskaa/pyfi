            ...
            {type !== 'installment' ?
                <>
                    {title.includes('Fatura:') ?
                        ...
                        : type !== 'debit' ?
                            <div className="mb-2">- R$ {(value).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} (na fatura)</div>
                            :
                            <div className="mb-2">- R$ {(value).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                    }
                ...
                <>
                    ...
                    <div className="mb-2 text-sm">{detailsB}X de R$ {(value).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} (na fatura)</div>
