...
export default function Header({ currentMonth, resources, savings, expenses, credit, page }) {
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center">
            {month !== undefined &&
                <div className="text-sm font-semibold mb-5 bg-pink-600 rounded-full py-1 px-2 text-white select-none">{month}</div>
            }
            <div className="text-4xl font-semibold mb-2 text-pink-600 select-none">{title}</div>
